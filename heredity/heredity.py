...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # number of copies of genes that each person has
    ...
    if not mom or not dad:
        ...
        def pass_prob(parent):
            """
            Probability that the parent passes on the gene
            """
        ...
        #probability of passing from each parent
        mom_prob = pass_prob(mom)
        dad_prob = pass_prob(dad)

        # gene passing probability
        if genes == 2:
