...
def transition_model(corpus, page, damping_factor):
    ...
    #check if links exists in the page
    if corpus[page]:
        ...
        for p in corpus[page]:
            distribution += damping_factor / len(corpus[page])

    #if no links exists in the page
    else:
...
def sample_pagerank(corpus, damping_factor, n):
    ...
    # keeps track of the number of visits of to each page
    ...
    for _ in range(n):
        ...
        #updatebthe page itself using transition_model
...
def iterate_pagerank(corpus, damping_factor):
    ...
    while True:
        ...
        #distribute and add linked pages' probalilities
        for page in corpus:
            #check if links are present on the current page
            if  corpus[page]:
                for p in corpus[page]:
